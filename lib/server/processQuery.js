...
module.exports = (req, res, next) => {
  ...
  // Grab the direcive defined in the LiveQL settings. And check if the
  // query is using it.
  ...
  // Remove the 'live' directives from the query.
  req.body.query = req.body.query.replace(/@live/g, '');
